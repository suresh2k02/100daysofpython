...
while True:
    ...
    while True:
        ...
        if shift_str.isdigit():
            ...
            if shift % len(alphabet) == 0:
                print("Invalid choice. Shifting by "+str(shift)+"would result in an identical message.")
            else:
    ...
    print("The message "+text+"" +direction+"d using a shift of "+str(shift)+" is "+result+".")
